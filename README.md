...
| 요약      | 스크린샷                                                     | 주요 작업 내역                                               | 날짜             |
| --------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ---------------- |
| 상품 목록 | ![image-20180708130520715](resource/image-20180708130520715.png) | - 로컬에있는 json  파일 불러와 TableView에 출력<br />- 상단의 섹션헤더 추가 <br />- Cell 내부에 동적으로 태그 Label 출력 | 2018-07-08 12:52 |
